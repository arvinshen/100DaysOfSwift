...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var numBall = 5 {
        didSet {
            ballLabel.text = "Remaining Balls: \(numBall)"
        }
    }
    ...
    override func didMove(to view: SKView) {
        ...
        ballLabel.position = CGPoint(x: 530, y: 700)
        addChild(ballLabel)
        ...
        for x in 0..<4 {
            let isGood = (x % 2) == 0 ? true : false
            makeSlot(at: CGPoint(x: 128 + 256 * x, y: 0), isGood: isGood)
        }

        for x in 0..<5 {
            makeBouncer(at: CGPoint(x: 256 * x, y: 0))
        }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if objects.contains(editLabel) {
            ...
            if editingMode {
                ...
                if Int(location.y) < 600 || Int(location.y) >= 700 {
                    ball.position = CGPoint(x: location.x, y: CGFloat.random(in: 600..<700))
                } else {
