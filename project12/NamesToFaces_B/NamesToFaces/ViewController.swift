...
//  NamesToFaces
//
//  Created by Arvin Shen on 12/18/21.
//
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let deleteButton = UIAlertAction(title: "Delete", style: .destructive) {
            [weak self] _ in
            let ac2 = UIAlertController(title: "Confirm Deletion", message: "Delete \(person.name)?", preferredStyle: .alert)
            
            ac2.addAction(UIAlertAction(title: "Delete", style: .destructive) {
                [weak self] _ in
