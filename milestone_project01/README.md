...
Flag Viewer is an app that lists names and images of country flags, that when selected will view the flag in larger detail. Flag Viewer is capable of sharing the images of the country flags.

#### [Challenges](https://www.hackingwithswift.com/guide/2/3/challenge)
...
Consolidation 1: Projects 1-3 - Flag Viewer is coded in correspondence to the following days:
* [Day 23] - Challenge Day
