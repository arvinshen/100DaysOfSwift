...
class GameScene: SKScene {
    ...
    func createFirework(xMovement: CGFloat, x: Int, y: Int) {
        ...
        // 3. Give the firework sprite node 1 of 3 random colors: cyan, green or red.
    ...
    @objc func launchFireworks() {
        ...
        case 2:
            // fire 5, from the left to the right
    ...
    func explode(firework: SKNode) {
        ...
        let removeFireworks = SKAction.removeFromParent()
        let delay = SKAction.wait(forDuration: 0.5)
        let removeExplosion = SKAction.removeFromParent()
        let sequence = SKAction.sequence([removeFireworks, delay, removeExplosion])
